  ...
  return (
    <section
      ...
      <motion.h1
        ...
        <span className="font-bold">Hello, I'm Eli.</span> I'm a{' '}
        <span className="font-bold">full-stack software engineer.</span> I enjoy
